...
//
	...
	extension TabBarCollectionView: UICollectionViewDragDelegate {
		func collectionView(_: UICollectionView, itemsForBeginning _: any UIDragSession, at indexPath: IndexPath) -> [UIDragItem] {
	...
	extension TabBarCollectionView: UICollectionViewDropDelegate {
		func collectionView(_ collectionView: UICollectionView, dropSessionDidUpdate _: any UIDropSession, withDestinationIndexPath _: IndexPath?) -> UICollectionViewDropProposal {
		...
		func collectionView(_: UICollectionView, performDropWith _: any UICollectionViewDropCoordinator) {
